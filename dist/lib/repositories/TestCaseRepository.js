...
let TestCaseRepository = class TestCaseRepository extends typeorm_1.Repository {
};
TestCaseRepository = __decorate([
    (0, typeorm_1.EntityRepository)(TestCase_entity_1.TestCase)
], TestCaseRepository);
